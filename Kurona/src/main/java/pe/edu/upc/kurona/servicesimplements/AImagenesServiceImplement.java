...
public class AImagenesServiceImplement implements IAImagenesService {
    ...
    @Override
    public List<AImagenes> buscarPorFormato(String formato) {return aR.findByFormatoIgnoreCase(formato);}

    @Override
    public List<Object[]> quantityDefectosPorLote() {return aR.quantityDefectosPorLote();}
    ...
    @Override
    public List<Object[]> cantidadImagenesPorLote() {return aR.cantidadImagenesPorLote();}
}
